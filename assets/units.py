...
FROSTBLASTER_LEVELS = [
    # lv0 – place cost 800
    (4,  0.608, 5.0, None, False, 0.50, 0.45, 3, 0.45, 0.00, 0.00, 420.0),
    # lv1 – upgrade 350
    (4,  0.508, 6.0,  350, True,  0.50, 0.60, 3, 0.60, 0.00, 0.00, 420.0),
    # lv2 – upgrade 1350
    (7,  0.508, 6.0, 1350, True,  0.75, 0.60, 3, 0.60, 0.15, 0.00, 420.0),
    # lv3 – upgrade 3200
    (8,  0.308, 6.5, 3200, True,  0.75, 0.60, 3, 0.60, 0.15, 0.00, 420.0),
    # lv4 – upgrade 8500
    (53, 0.908, 8.5, 8500, True,  0.75, 1.50, 3, 1.50, 0.15, 0.35, 450.0),
]
