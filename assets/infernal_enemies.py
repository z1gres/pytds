...
# ── 1. Волк (Wolf) ────────────────────────────────────────────────────────────
class Wolf(Enemy):
    """30 HP, default speed (55)."""
    DISPLAY_NAME = "Wolf"; BASE_HP = 30; BASE_SPEED = _WOLF_SPD; KILL_REWARD = 15
...
class SpeedyWolf(Enemy):
    """15 HP, 20% faster than wolf."""
    DISPLAY_NAME = "Speedy Wolf"; BASE_HP = 15; BASE_SPEED = int(_WOLF_SPD * 1.20); KILL_REWARD = 12
    def __init__(self, wave=1):
        super().__init__(wave)
        self.hp = self.BASE_HP; self.maxhp = self.hp
...
class SnowCorpse(Enemy):
    """Snowman Corpse. 60 HP, stationary."""
    DISPLAY_NAME = "Snowman (corpse)"; BASE_HP = 60; BASE_SPEED = 0; KILL_REWARD = 5
...
class Snowball(Enemy):
    """140 HP, +10% wolf speed. Spawns SnowCorpse on death."""
    DISPLAY_NAME = "Snowball"; BASE_HP = 140; BASE_SPEED = int(_WOLF_SPD * 1.10); KILL_REWARD = 40
...
class Ember(Enemy):
    """Coal. 25 HP, +10% speed. Debuff: -25% damage."""
    DISPLAY_NAME = "Coal"; BASE_HP = 25; BASE_SPEED = int(_WOLF_SPD * 1.10); KILL_REWARD = 8
    ...
    def tick_debuff(self):
        """Return True every 2s -> apply debuff to units nearby."""
...
class Furnace(Enemy):
    """Furnace mini-boss. 350 HP. Flame stun. Drops 3 coals."""
    DISPLAY_NAME = "Furnace"; BASE_HP = 350; BASE_SPEED = int(_WOLF_SPD * 0.855); KILL_REWARD = 120
    def __init__(self, wave=1):
        super().__init__(wave)
        self.hp = self.BASE_HP; self.maxhp = self.hp
    ...
    def should_stun(self):
        """Return True -> units in radius 100 stunned for 1.5s."""
...
class Untouchable(Enemy):
    ...
    """
    DISPLAY_NAME = "Untouchable"; BASE_HP = 1; BASE_SPEED = _WOLF_SPD; KILL_REWARD = 80
...
class SpecterEnemy(Enemy):
    ...
    def take_damage_from(self, dmg, attacker_class_name):
        """Called for Cowboy/Gladiator/Archer."""
        if attacker_class_name in self.ALLOWED_KILLERS:
            self.hp -= dmg
            if self.hp <= 0:
                self.hp = 0
...
class FateCollector(Enemy):
    ...
    """
    DISPLAY_NAME = "Collector of Fate"; BASE_HP = 80; BASE_SPEED = _WOLF_SPD; KILL_REWARD = -100
...
class Stomp(Enemy):
    """150 HP, default speed. Periodically stuns nearby units (range 90)."""
    DISPLAY_NAME = "Stomp"; BASE_HP = 150; BASE_SPEED = _WOLF_SPD; KILL_REWARD = 60
    def __init__(self, wave=1):
        super().__init__(wave)
...
class InfernalStone(Enemy):
    """Rock. 1300 HP, slow."""
    DISPLAY_NAME = "Rock"; BASE_HP = 1300; BASE_SPEED = 28; KILL_REWARD = 200
    def __init__(self, wave=1, x=None, y=None, wp_index=None):
        super().__init__(wave)
...
class InfernalMystery(Enemy):
    ...
    """
    DISPLAY_NAME = "Mystery"; BASE_HP = 50; BASE_SPEED = 130; KILL_REWARD = 30
    ...
    def get_mystery_drop(self):
        """Called on death. Returns enemies."""
        r = random.random()
...
class Terpila(Enemy):
    ...
    """
    DISPLAY_NAME = "Patient"; BASE_HP = 1500; BASE_SPEED = int(_WOLF_SPD * 0.50); KILL_REWARD = 500
    ...
    def should_rage_stun(self):
        """Return True every 3s in rage -> stun 1 unit."""
...
class Putana(Enemy):
    ...
    """
    DISPLAY_NAME = "Whore"; BASE_HP = 5000; BASE_SPEED = int(_WOLF_SPD * 0.625); KILL_REWARD = 0
    BUYOUT_COST = 1000
    def __init__(self, wave=1):
        super().__init__(wave)
...
class Silyach(Enemy):
    ...
    """
    DISPLAY_NAME = "Cigarette"; BASE_HP = 2000; BASE_SPEED = int(_WOLF_SPD * 0.70); KILL_REWARD = 800
...
class Confusilionale(Enemy):
    ...
    """
    DISPLAY_NAME = "Confusionale"; BASE_HP = 4200; BASE_SPEED = int(_WOLF_SPD * 0.60); KILL_REWARD = 600
    def __init__(self, wave=1):
        super().__init__(wave)
...
class Wheelchair(Enemy):
    ...
    """
    DISPLAY_NAME = "Invalid"; BASE_HP = 1500; BASE_SPEED = int(_WOLF_SPD * 0.90); KILL_REWARD = 1000
    def __init__(self, wave=1):
        super().__init__(wave)
        self.hp = 1500; self.maxhp = 1500
        self.speed = self.BASE_SPEED + (wave - 1)
...
class BlackSquare(Enemy):
    """4000 HP, ARMOR=0.20, 20% slower than wolf."""
    DISPLAY_NAME = "Black Square"; BASE_HP = 4000; BASE_SPEED = int(_WOLF_SPD * 0.80)
...
class FallenChester(Enemy):
    """Fallen Chester. High damage, 300 HP, fast."""
...
class FastFallenChester(FallenChester):
    """Chester 30% faster (wave 9 Challenger)."""
...
class TowerDestroyer(Enemy):
    ...
    """
    DISPLAY_NAME = "Destroyer"; BASE_HP = 2000; BASE_SPEED = _WOLF_SPD; KILL_REWARD = 0
...
class GrandpaEnemy(Enemy):
    """Grandpa, chases Kolobok. 5000 HP."""
    DISPLAY_NAME = "Grandpa"; BASE_HP = 5000; BASE_SPEED = int(_WOLF_SPD * 0.60); KILL_REWARD = 300
    def __init__(self, wave=1):
        super().__init__(wave)
        self.hp = 5000; self.maxhp = 5000
...
class GrandmaEnemy(Enemy):
    """Babka, chases Kolobok. 5000 HP. Stuns units."""
    DISPLAY_NAME = "Babka"; BASE_HP = 5000; BASE_SPEED = int(_WOLF_SPD * 0.65); KILL_REWARD = 250
    def __init__(self, wave=1):
        super().__init__(wave)
        self.hp = 5000; self.maxhp = 5000
...
class Kolobok(Enemy):
    ...
    """
    DISPLAY_NAME = "Kolobok (Final Boss)"; BASE_HP = 80000; BASE_SPEED = 20; KILL_REWARD = 0
    def __init__(self, wave=1):
        super().__init__(1)
